<%@ Page Title="" Language="C#" MasterPageFile="~/user/Main.Master" AutoEventWireup="true" EnableEventValidation="false" CodeBehind="Appointment.aspx.cs" Inherits="Electronic_Health_Record.Appointment1" %>
    ...
    <div class="content">
        <div class="contact-us">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-12">
                         <asp:Label Text="" ID="lbl_docid" Visible="true" runat="server" />
            ...
            <div class="leave-msg dark-back">
                                ...
                                <div class="row">
                                    ...
                                    <div name="contact_form" id="contact_form">
                                        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                            <ContentTemplate>
                                                <div class="col-md-8">
                                                    <asp:Label Text="Please Enter Problem" ID="pat_prob" runat="server" />
                                                    <asp:TextBox runat="server" TextMode="MultiLine" ID="patient_problem"  />    
                ...
                <asp:Panel runat="server" ID="popup1" CssClass="modalPopup">
                    ...
                    <%-- <asp:CheckBoxList runat="server" ID="bind_doctor_time">
                       
                    </asp:CheckBoxList>
                    --%>
                    
                    <asp:RadioButtonList ID="bind_doc_time" RepeatColumns="3"  CellSpacing="20" ToolTip="Select Available Time" CellPadding="14" runat="server">
