...
{
    public partial class manageinsurance : System.Web.UI.Page
    {
        ...
        protected void OnItemUpdating(object sender, ListViewUpdateEventArgs e)
        {
            ...
            Session["iID"] = evt_id;
            Response.Redirect("updateinsurance.aspx");
        }
        protected void OnItemDeleting(object source, ListViewDeleteEventArgs e)
        {
            ...
            cmdselect.CommandText = "dbo.Delete_Insurance";
            cmdselect.Parameters.AddWithValue("@iid", e_id);
        ...
        {
            con.Close();
            string query = "SELECT i_id, fname, lname, dob, phoneno, email, imagename, licenceno, username FROM insurance_signup_table";
            con.Open();
