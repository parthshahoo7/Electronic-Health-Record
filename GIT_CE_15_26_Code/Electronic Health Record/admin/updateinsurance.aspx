<%@ Page Title="" Language="C#" MasterPageFile="~/admin/adminpanel.Master" AutoEventWireup="true" CodeBehind="updateinsurance.aspx.cs" Inherits="Electronic_Health_Record.admin.updateinsurance" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">Update Insurance
        </li>
            ...
            <fieldset>
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <i class="fa fa-plus"></i>Update Insurance
