<%@ Page Title="" Language="C#" MasterPageFile="~/admin/adminpanel.Master" AutoEventWireup="true" CodeBehind="manageinsurance.aspx.cs" Inherits="Electronic_Health_Record.admin.manageinsurance" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     ...
     <ol class="breadcrumb">
       ...
       <li>
        ...
        <li class="active">Manage Insurance
        </li>
            ...
            <fieldset>
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <i class="fa fa-file"></i>Manage Insurance Details
                        ...
                        <asp:ListView ID="lstProduct" runat="server" GroupPlaceholderID="groupPlaceHolder1"
                            ...
                            <ItemTemplate>
                                <tr>
                                    ...
                                    <asp:Label ID="lblID" Visible="False" runat="Server" Text='<%# Eval("i_id") %>'></asp:Label>
                                    <td>
