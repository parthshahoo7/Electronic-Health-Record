<%@ Page Title="" Language="C#" MasterPageFile="~/admin/adminpanel.Master" AutoEventWireup="true" CodeBehind="managestate.aspx.cs" Inherits="Electronic_Health_Record.admin.managestate" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <asp:RequiredFieldValidator ID="reqDETAIL" runat="server" ForeColor="Red" ErrorMessage="State Name Required.."
                ControlToValidate="txtStatename" ValidationGroup="valInsert"></asp:RequiredFieldValidator><br />
            ...
            <div class="form-horizontal">
                <div class="form-group">
                 ...
                 <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                   <asp:TextBox ID="txtStatename" runat="server" placeholder="State Name"   CssClass="form-control" />
                                </div>
                            </div>
                                <div class="row">
                                    <div class="col-sm-2 col-sm-offset-3">
                        <asp:Button ID="btnInsert" ValidationGroup="valInsert" CssClass="btn btn-blue next-step btn-block" runat="server" Text="Add State"
    ...
    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
        <ContentTemplate>
            <fieldset>
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <i class="fa fa-file"></i>Manage State
                                <div class="panel-tools">
                        ...
                        <asp:ListView ID="lstSubEvent" runat="server"
                            ...
                            <ItemTemplate>
                                <tr>
                                    ...
                                    <asp:Label ID="lblStateID" Visible="False" runat="server" Text='<%# Eval("state_id") %>'></asp:Label>
                                    </td>
                                    <td>
                            ...
                            <EditItemTemplate>
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator5" ForeColor="Red" runat="server"
                                    ErrorMessage="State Name Required.." ControlToValidate="txtStateName" ValidationGroup="valView"></asp:RequiredFieldValidator><br />
                                <tr>
                                    <th class="center">
                                        <div class="checkbox-table">
                                            <label>
